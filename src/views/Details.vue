            ...
            <div class="row">
                ...
                <div class="row mb-3">
                    <div class="mt-3 mb-4 col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        ...
                        <input type="text" ref="own_finance" class="form-control" placeholder="0 GEL" name="finance" id="finance" disabled v-model="this.own_finance">
                    </div>
                    <div class="mt-3 mb-4 col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <label for="agency_finance" class="mb-2">სააგენტოს დაფინანსება</label>
                        <input type="text" ref="agency_finance" class="form-control" placeholder="0 GEL" name="agency_finance" id="agency_finance" v-model="this.agency_finance" disabled>
                    </div>
                </div>

                <div class="row">
                    <strong><p style="text-align: right">სულ&nbsp;<big>{{ this.statement?.total_price }}&nbsp;GEL</big></p></strong>
                </div>
            </div>
        </div>
        <Footer />
    ...
    export default {
        ...
        async mounted() {
            ...
            try {
                ...
                this.own_finance = this.statement?.own_finance;
                this.agency_finance = this.statement?.agency_finance;
