<template>
    <div>
        ...
        <div class="container bg-white p-4 mt-5">
            <div class="table-responsive" v-if="show && this.role_title == 'ბენეფიციარი'">
            ...
            <div v-if="this.role_title != 'ბენეფიციარი'">
...
<script>
    ...
    export default {
        ...
        async mounted() {
            ...
            this.$store.dispatch("setRoleName");

            this.role = this.$store.state.role;
            this.role_name = this.$store.state.role_name;

            console.log(this.$store.state.role_name);
