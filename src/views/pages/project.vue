    ...
    <Transition name="fade" appear>
        ...
        <aside>
            ...
            <form class="app-form" @submit.prevent="add">
                ...
                <component v-bind:is="DynamicForm" :errors="form.errors" :inputs="form.inputs" :project_types="form.data.project.project_types" :currency="form.data.currency" :is_legal="form.params.is_legal"></component>
