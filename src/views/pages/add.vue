    ...
    <Transition name="fade" appear>
        ...
        <aside v-if="ready">
            ...
            <form class="app-form" @submit.prevent="add">
                ...
                <component v-if="ready" v-bind:is="DynamicForm" :processing="form.processing" :errors="form.errors" :project_types="form.data.project.project_types" :currency="form.data.currency" :is_legal="form.params.is_legal" :read="false"></component>
...
export default {
    ...
    computed : {
        ...
        ...mapState({
            ...
            ready(state) {
                ...
                return state.ready && Object.keys(this.form.data).length
    ...
    methods : {
        ...
        add() {
            ...
            axios.post("/application/add", { ...this.form.inputs, ...this.dynamic.inputs }).then(response => {
                ...
                this.$router.push({ path: '/applications', query: { popup: 'documents', id: response.data.application } })
    ...
    mounted() {
        ...
        axios.post("/settings/collector", { params: { name: this.$route.query.name }, data: ['project', 'currency', 'genders', 'juridical_status', 'legal_status'] }).then(response => {
