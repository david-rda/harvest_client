    ...
    <Transition name="fade" appear>
        ...
        <aside>
            ...
            <div class="app-table-buttons">
                ...
                <div class="app-page-title">ახალი მომხმარებლის დამატება</div>
            ...
            <div class="app-form">
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="row">
                        ...
                        <div class="form-input col-6 mb-3" :data-error="!!form.state.role_id.error.length">
                            ...
                            <select class="form-select" id="role_id" v-model="form.inputs.role_id">
                                <option value="0" selected disabled>აირჩიეთ დაშვების დონე</option>
                    ...
                    <div class="form-buttons mt-3 mb-4">
                        <button type="submit" class="btn btn-success">ანგარიშის შექმნა</button>
                    </div>
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            axios.post("/user/add", this.form.inputs).then(response => {
